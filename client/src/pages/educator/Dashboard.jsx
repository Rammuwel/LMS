...
function Dashboard() {
  ...
  return dashboardData ? (
    <div className='min-h-screen w-full flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pb-0'>
      <div className='space-y-5'>
        ...
        <div>
           <h2 className='pb-4 text-lg font-medium'>Latest Enrolment</h2>
           <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20'>
               <table className=' md:table-auto w-full overflow-hidden'>
                  <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left'>
                     <tr>
                       <td className='px-4 py-3 font-semibold text-center hidden sm:table-cell'>#</td>
