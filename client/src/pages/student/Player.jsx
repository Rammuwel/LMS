...
function Player() {
   ...
   const {enrolledCourses,fetchUserEnrolledCourses, calculateChapterTime, backendUrl, getToken, userData} = useContext(AppContext);
      ...
      if(course._id === courseId){
        ...
        course.courseRatings.map((item)=>{
           if(item.userId === userData._id){
              setInitialRating(item.courseRatings)
           }
        })
      }
    })
  ...
  return courseData ? (
    <>
      ...
      md:px-36'>
        ...
        {/* left col */}
        <div>
          <h2 className='text-xl font-semibold'>Courrse Structure</h2>
          <div className='pt-5'>
        ...
        <div className='md:mt-10'>
            ...
            playerData ? (
              <div className=''>
                <YouTube videoId={playerData.lectureUrl.split('/').pop()} iframeClassName='w-full aspect-video'></YouTube>
